-- 0042 · El portal del proveedor recibe los complementos del encargo (los adornos del taller en Notelodigo).
-- Se pueden ocultar con ajustes.complementos_a_proveedor = false. Cambia lo que devuelve: hay que borrarla y crearla.
