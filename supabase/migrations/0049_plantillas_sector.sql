-- 0049 · Plantillas por sector completas
-- crear_tienda acepta ahora: serie, menú propio (aparte) y bandejas por tipo; grupo y hoja de
-- producción por etapa; asunto y «al abrir incidencia» en mensajes; material y consumo en
-- productos; tipo y unidad de pedido en proveedores; y materiales de ejemplo.
...
declare
  ...
  v_etapas jsonb; v_aparte jsonb := '[]'::jsonb; v_band_tipo jsonb := '{}'::jsonb; v_prov uuid;
begin
