...
export async function guardarProducto(tiendaId: string, id: string | null, p: { nombre: string; precio_base: number | null; foto_url: string | null; activo: boolean; datos: Record<string, unknown> }) {
