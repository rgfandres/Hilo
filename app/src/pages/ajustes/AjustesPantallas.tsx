...
export function AjustesPantallas() {
  ...
  return (
    <>
      <Pagina titulo="Qué ve cada papel" ayuda="Las pantallas del menú (y de la barra del móvil) de cada papel. Administración lo ve todo."
        mas="Solo cambia lo que se ve en el menú y a dónde se puede entrar; lo que cada papel puede hacer lo marcan sus permisos. Las fichas sueltas (un encargo, un cliente) se pueden abrir siempre desde un enlace." />
