...
export function AppShell() {
  ...
  React.useEffect(() => {
    ...
    const inicio = rol === 'LOGISTICA' ? '/encargos?b=mio' : '/'
  ...
  const destinos = rol === 'LOGISTICA'
    ? [{ to: '/encargos?b=mio', label: 'Mi trabajo', icon: IconListCheck }, { to: '/encargos', label: vocab.encargos, icon: IconLayoutList, n: cuenta.encargos },
